...
def collect_inputs() -> SimpleNamespace:
    ...
    return SimpleNamespace(
        ...
        t1_offset_x=prompt_float("T1 offset X relative to T0", 12.5),
        t1_offset_y=prompt_float("T1 offset Y relative to T0", 0.5),
        t1_offset_z=prompt_float("T1 offset Z relative to T0", -0.45),
