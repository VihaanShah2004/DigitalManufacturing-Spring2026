...
tab_width = min(w, h) / 10   # joint width (same for tab and main groove)
...
# hole centers inset from edge (inside the base rectangle)
hole_inset = w / 4
...
file.write('\n')
file.write(f'  <g transform="translate({x + margin}, {y + margin})" stroke="black" stroke-width="{stroke_width}" fill="none">')
file.write('\n')
