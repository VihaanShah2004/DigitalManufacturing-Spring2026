...
try:
    ...
    length = float(input("Type length to start: "))
    width = float(input("Type width to start: "))
    height = float(input("Type height to start: "))
...
if width <= 0 or height <= 0 or length <= 0:
    print("Invalid input. Length, width, and height must be greater than 0.")
    exit()
if stroke_width <= 0:
