...
stroke_color = input("Type fistrll color coordinate to start")

#Write SVG File
file = open("demofile.svg", "w")
file.write('<?xml version="1.0" encoding="UTF-8" ?>')
file.write('<svg xmlns="http://www.w3.org/2000/svg" version="1.1">')
file.write(f'<rect x="{x}" y="{y}" width="{width}" height="{height}" rx="3" ry="3" style="stroke-width:{stroke_width};stroke:rgb(0,0,0);fill:{color}" />')
file.close()